...
# %bb.0:
	...
	subq	$55144, %rsp                    # imm = 0xD768
	.cfi_def_cfa_offset 55200
	.cfi_offset %rbx, -56
	.cfi_offset %r12, -48
	.cfi_offset %r13, -40
	.cfi_offset %r14, -32
...
.LBB0_36:                               #   in Loop: Header=BB0_16 Depth=2
	...
	vpbroadcastq	.LCPI0_4(%rip), %ymm5   # ymm5 = [2147483646,2147483646,2147483646,2147483646]
	vpbroadcastq	.LCPI0_5(%rip), %ymm6   # ymm6 = [18446744071562067968,18446744071562067968,18446744071562067968,18446744071562067968]
	vpbroadcastq	.LCPI0_6(%rip), %ymm7   # ymm7 = [1,1,1,1]
	vpbroadcastq	.LCPI0_7(%rip), %ymm8   # ymm8 = [2567483615,2567483615,2567483615,2567483615]
	jmp	.LBB0_37
	.p2align	4, 0x90
.LBB0_43:                               #   in Loop: Header=BB0_37 Depth=3
	movq	136(%rsp,%rsi,8), %rcx
	incq	%rsi
.LBB0_44:                               #   in Loop: Header=BB0_37 Depth=3
	...
	xorq	%rdi, %rcx
	movl	%ecx, %edi
	andl	$122764, %edi                   # imm = 0x1DF8C
	shlq	$15, %rdi
	xorq	%rcx, %rdi
	movq	%rdi, %rcx
	shrq	$18, %rcx
	xorq	%rdi, %rcx
	vcvtusi2sd	%rcx, %xmm9, %xmm2
	vmovsd	%xmm1, 120(%rsp)
	fldl	120(%rsp)
	fmuls	.LCPI0_0(%rip)
	vfmadd231sd	%xmm2, %xmm1, %xmm0     # xmm0 = (xmm1 * xmm2) + xmm0
	fstpl	112(%rsp)
	vmovsd	112(%rsp), %xmm1                # xmm1 = mem[0],zero
	leaq	1(%rdx), %rcx
	cmpq	%rax, %rdx
	movq	%rcx, %rdx
	je	.LBB0_45
...
.LBB0_39:                               #   Parent Loop BB0_3 Depth=1
	...
	vmovdqu	144(%rsp,%rcx), %ymm2
	vpand	%ymm5, %ymm2, %ymm3
	vpbroadcastq	%rbx, %ymm4
	valignq	$3, %ymm4, %ymm2, %ymm4         # ymm4 = ymm4[3],ymm2[0,1,2]
	vpternlogq	$236, %ymm6, %ymm3, %ymm4
	vpsrlq	$1, %ymm4, %ymm3
	vptestmq	%ymm7, %ymm2, %k1
	vmovdqa64	%ymm8, %ymm2 {%k1} {z}
	vpternlogq	$150, 3312(%rsp,%rcx), %ymm3, %ymm2
	vmovdqu	%ymm2, 136(%rsp,%rcx)
	movq	168(%rsp,%rcx), %rbx
	addq	$32, %rcx
...
# %bb.40:                               #   in Loop: Header=BB0_37 Depth=3
	...
	andq	$-2147483648, %rbx              # imm = 0x80000000
	orq	%rcx, %rbx
	shrq	%rbx
	xorq	5104(%rsp), %rbx
	movq	1944(%rsp), %rcx
...
.LBB0_41:                               #   Parent Loop BB0_3 Depth=1
                                        ...
                                        #       Parent Loop BB0_37 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	vmovdqu	1960(%rsp,%rcx), %ymm2
	vpand	%ymm5, %ymm2, %ymm3
	valignq	$3, 1952(%rsp,%rcx){1to4}, %ymm2, %ymm4
	vpternlogq	$236, %ymm6, %ymm3, %ymm4
	vpsrlq	$1, %ymm4, %ymm3
	vptestmq	%ymm7, %ymm2, %k1
	vmovdqa64	%ymm8, %ymm2 {%k1} {z}
	vpternlogq	$150, 136(%rsp,%rcx), %ymm3, %ymm2
	vmovdqu	%ymm2, 1952(%rsp,%rcx)
	addq	$32, %rcx
...
.LBB0_27:                               #   in Loop: Header=BB0_16 Depth=2
	...
	vfmadd132sd	.LCPI0_8(%rip), %xmm1, %xmm0 # xmm0 = (xmm0 * mem) + xmm1
...
# %bb.1:
	...
	vpbroadcastq	.LCPI2_2(%rip), %ymm2   # ymm2 = [1,1,1,1]
	vpbroadcastq	.LCPI2_3(%rip), %ymm3   # ymm3 = [2567483615,2567483615,2567483615,2567483615]
	.p2align	4, 0x90
.LBB2_2:                                # =>This Inner Loop Header: Depth=1
	vmovdqu	136(%rdi,%rax,8), %ymm4
	vmovdqu	168(%rdi,%rax,8), %ymm5
	...
	vpternlogq	$248, 160(%rdi,%rax,8), %ymm1, %ymm11
	vpternlogq	$248, 128(%rdi,%rax,8), %ymm1, %ymm10
	vpternlogq	$248, 224(%rdi,%rax,8), %ymm1, %ymm9
	vpternlogq	$248, 192(%rdi,%rax,8), %ymm1, %ymm8
	vpsrlq	$1, %ymm8, %ymm8
	vpsrlq	$1, %ymm9, %ymm9
	vpsrlq	$1, %ymm10, %ymm10
	vpsrlq	$1, %ymm11, %ymm11
	vptestmq	%ymm2, %ymm5, %k1
	vptestmq	%ymm2, %ymm4, %k2
	vptestmq	%ymm2, %ymm7, %k3
	vptestmq	%ymm2, %ymm6, %k4
	vmovdqa64	%ymm3, %ymm4 {%k4} {z}
	vmovdqa64	%ymm3, %ymm5 {%k3} {z}
	vmovdqa64	%ymm3, %ymm6 {%k2} {z}
	vmovdqa64	%ymm3, %ymm7 {%k1} {z}
	vpternlogq	$150, 3336(%rdi,%rax,8), %ymm11, %ymm7
	vpternlogq	$150, 3304(%rdi,%rax,8), %ymm10, %ymm6
	vpternlogq	$150, 3400(%rdi,%rax,8), %ymm9, %ymm5
	vpternlogq	$150, 3368(%rdi,%rax,8), %ymm8, %ymm4
	vmovdqu	%ymm4, 192(%rdi,%rax,8)
	vmovdqu	%ymm5, 224(%rdi,%rax,8)
	vmovdqu	%ymm6, 128(%rdi,%rax,8)
	vmovdqu	%ymm7, 160(%rdi,%rax,8)
	addq	$16, %rax
	cmpq	$208, %rax
	jb	.LBB2_2
# %bb.3:
...
.LBB2_4:                                # =>This Inner Loop Header: Depth=1
	...
	valignq	$3, 1816(%rdi,%rax){1to4}, %ymm4, %ymm6
	vpternlogq	$236, %ymm1, %ymm5, %ymm6
	vpsrlq	$1, %ymm6, %ymm5
	vptestmq	%ymm2, %ymm4, %k1
	vmovdqa64	%ymm3, %ymm4 {%k1} {z}
	vpternlogq	$150, (%rdi,%rax), %ymm5, %ymm4
...
# %bb.10:                               #   in Loop: Header=BB5_9 Depth=1
	...
	vandpd	.LCPI5_2(%rip){1to2}, %xmm0, %xmm0
...
# %bb.51:                               #   in Loop: Header=BB5_9 Depth=1
	...
	xorl	%edi, %edi
	leaq	200(%rsp), %rbx
	vmovddup	.LCPI5_2(%rip), %xmm1           # xmm1 = [NaN,NaN]
                                        # xmm1 = mem[0,0]
	.p2align	4, 0x90
...
# %bb.55:                               #   in Loop: Header=BB5_9 Depth=1
	vandpd	.LCPI5_2(%rip){1to2}, %xmm3, %xmm0
...
.LBB7_2:
	vxorpd	%xmm1, %xmm1, %xmm1
	vmovupd	%xmm1, 80(%rsp)                 # AlignMOV convert to UnAlignMOV 
	movq	$0, 96(%rsp)
	xorl	%r12d, %r12d
	jmp	.LBB7_7
.LBB7_5:
...
# %bb.8:
	...
	vxorpd	%xmm0, %xmm0, %xmm0
	leaq	5184(%rsp), %rbx
	movabsq	$945986875574848801, %r12       # imm = 0xD20D20D20D20D21
...
# %bb.10:                               #   in Loop: Header=BB7_9 Depth=1
	...
	vandpd	.LCPI7_2(%rip){1to2}, %xmm1, %xmm1
...
# %bb.85:                               #   in Loop: Header=BB7_80 Depth=2
	movq	48(%rsp), %rdx                  # 8-byte Reload
	vmovsd	(%r13,%rdx,8), %xmm0            # xmm0 = mem[0],zero
	movq	160(%rsp), %rdx                 # 8-byte Reload
	.p2align	4, 0x90
...
# %bb.51:                               #   in Loop: Header=BB7_9 Depth=1
	...
	vxorpd	%xmm2, %xmm2, %xmm2
	xorl	%edi, %edi
	vmovddup	.LCPI7_2(%rip), %xmm1           # xmm1 = [NaN,NaN]
                                        # xmm1 = mem[0,0]
	.p2align	4, 0x90
...
# %bb.54:                               #   in Loop: Header=BB7_9 Depth=1
	vxorpd	%xmm0, %xmm0, %xmm0
	vmovupd	64(%rsp), %xmm1                 # 16-byte Reload
                                        # AlignMOV convert to UnAlignMOV 
	vucomisd	%xmm0, %xmm1
	vmovsd	16(%rsp), %xmm2                 # 8-byte Reload
                                        # xmm2 = mem[0],zero
...
# %bb.55:                               #   in Loop: Header=BB7_9 Depth=1
	vandpd	.LCPI7_2(%rip){1to2}, %xmm1, %xmm0
...
# %bb.9:                                #   in Loop: Header=BB9_8 Depth=1
	vmovsd	(%r13), %xmm0                   # xmm0 = mem[0],zero
	vandpd	.LCPI9_2(%rip){1to2}, %xmm0, %xmm0
...
# %bb.50:                               #   in Loop: Header=BB9_8 Depth=1
	...
	xorl	%edi, %edi
	leaq	200(%rsp), %rbx
	vmovddup	.LCPI9_2(%rip), %xmm1           # xmm1 = [NaN,NaN]
                                        # xmm1 = mem[0,0]
	.p2align	4, 0x90
...
# %bb.54:                               #   in Loop: Header=BB9_8 Depth=1
	vandpd	.LCPI9_2(%rip){1to2}, %xmm3, %xmm0
	vdivsd	%xmm0, %xmm2, %xmm0
	jmp	.LBB9_8
.LBB9_65:
	movl	$.Lstr.22, %edi
...
.Lttbase3:
	.p2align	2, 0x0
                                        # -- End function
	.section	.rodata.cst8,"aM",@progbits,8
	.p2align	3, 0x0                          # -- Begin function _Z12gen_fpnumberIdEvRSt6vectorIT_SaIS1_EEiS1_RS1_
.LCPI10_0:
	.quad	0x7fffffffffffffff              #  NaN
.LCPI10_1:
	.quad	0x3810000000000000              #  1.1754943508222875E-38
...
# %bb.0:
	...
	callq	log@PLT
	vmovsd	%xmm0, 16(%rsp)                 # 8-byte Spill
	vcvtusi2sd	%ebp, %xmm1, %xmm0
	vmulsd	.LCPI14_3(%rip), %xmm0, %xmm0
	vpbroadcastq	.LCPI14_5(%rip), %xmm1  # xmm1 = [-0.0E+0,-0.0E+0]
	vpternlogq	$234, .LCPI14_4(%rip){1to2}, %xmm0, %xmm1
	vaddsd	%xmm1, %xmm0, %xmm0
...
.LBB14_10:                              # =>This Inner Loop Header: Depth=1
	...
	vcvtss2sd	%xmm0, %xmm0, %xmm0
	kmovd	%eax, %k1
	vmovsd	.LCPI14_8(%rip), %xmm1          # xmm1 = mem[0],zero
	vmovsd	.LCPI14_3(%rip), %xmm1 {%k1}
...
# %bb.11:
	vmovsd	56(%rsp), %xmm0                 # 8-byte Reload
                                        # xmm0 = mem[0],zero
	vmulsd	.LCPI14_3(%rip), %xmm0, %xmm0
	vpbroadcastq	.LCPI14_4(%rip), %xmm1  # xmm1 = [4.9999999999999994E-1,4.9999999999999994E-1]
	vpternlogq	$248, .LCPI14_5(%rip){1to2}, %xmm0, %xmm1
	vaddsd	%xmm1, %xmm0, %xmm0
	vroundsd	$11, %xmm0, %xmm0, %xmm0
	vaddsd	.LCPI14_2(%rip), %xmm0, %xmm0
	vcvtsd2ss	%xmm0, %xmm0, %xmm0
	vaddss	.LCPI14_6(%rip), %xmm2, %xmm1
...
.LBB14_12:                              # =>This Inner Loop Header: Depth=1
	...
	vmulss	.LCPI14_7(%rip), %xmm0, %xmm0
	vcvtss2sd	%xmm0, %xmm0, %xmm0
	vmovsd	.LCPI14_10(%rip), %xmm1         # xmm1 = mem[0],zero
	vfmadd132sd	.LCPI14_9(%rip), %xmm1, %xmm0 # xmm0 = (xmm0 * mem) + xmm1
	vcvtsd2ss	%xmm0, %xmm0, %xmm0
	vcvtss2sd	%xmm0, %xmm0, %xmm0
	vmovsd	%xmm0, 16(%rsp)                 # 8-byte Spill
	movl	%ebx, %ebp
...
.LBB14_13:
	...
	vmovss	%xmm0, (%rcx)
	vaddss	.LCPI14_6(%rip), %xmm4, %xmm0
	vcvttss2usi	%xmm0, %rax
	movl	$0, (%rcx,%rax,4)
.LBB14_14:
	vcvtusi2ssl	36(%rsp), %xmm3, %xmm0  # 4-byte Folded Reload
	vsubss	%xmm4, %xmm0, %xmm6
	vcvttss2usi	%xmm6, %rbp
	cmpq	%r14, %rbp
...
.LBB14_19:
	...
	vaddss	.LCPI14_6(%rip), %xmm6, %xmm0
	vmovss	%xmm5, (%rbx)
	vucomiss	.LCPI14_11(%rip), %xmm6
	jbe	.LBB14_22
# %bb.20:
...
.LBB14_21:                              # =>This Inner Loop Header: Depth=1
	...
	incl	%ecx
	vcvtusi2ss	%ecx, %xmm7, %xmm3
	vucomiss	%xmm3, %xmm6
	ja	.LBB14_21
.LBB14_22:
	vcvtsd2ss	%xmm1, %xmm1, %xmm1
	vmovss	%xmm1, 52(%rsp)                 # 4-byte Spill
	vcvttss2usi	%xmm0, %rax
	movl	$0, (%rbx,%rax,4)
...
# %bb.23:
	...
	subq	%r15, %r13
	movq	%r13, %rcx
	vcvttss2usi	52(%rsp), %ebp          # 4-byte Folded Reload
	sarq	$2, %rcx
...
.LBB14_24:                              #   in Loop: Header=BB14_25 Depth=1
	incq	%r12
	cmpl	%r12d, 176(%rsp)                # 4-byte Folded Reload
	je	.LBB14_33
.LBB14_25:                              # =>This Inner Loop Header: Depth=1
	callq	rand
	movl	%eax, %r14d
	vcvtusi2ss	%r12d, %xmm7, %xmm0
	vmovss	%xmm0, 16(%rsp)                 # 4-byte Spill
	vsubss	12(%rsp), %xmm0, %xmm0          # 4-byte Folded Reload
	vcvttss2usi	%xmm0, %rax
	vcvttss2si	(%rbx,%rax,4), %edi
	vmovsd	.LCPI14_2(%rip), %xmm0          # xmm0 = mem[0],zero
	callq	ldexp@PLT
	vcvtsi2ss	%r14d, %xmm7, %xmm1
	vmulss	.LCPI14_7(%rip), %xmm1, %xmm1
	vcvtss2sd	%xmm1, %xmm1, %xmm1
	vmovsd	%xmm0, 64(%rsp)                 # 8-byte Spill
	vmovsd	.LCPI14_10(%rip), %xmm0         # xmm0 = mem[0],zero
	vfmadd132sd	.LCPI14_9(%rip), %xmm0, %xmm1 # xmm1 = (xmm1 * mem) + xmm0
	vmovsd	%xmm1, 56(%rsp)                 # 8-byte Spill
	vxorpd	%xmm0, %xmm0, %xmm0
...
.LBB14_30:                              #   in Loop: Header=BB14_25 Depth=1
	movq	%rbx, 120(%rsp)
	vcvttss2usi	16(%rsp), %esi          # 4-byte Folded Reload
.Ltmp231:
	leaq	112(%rsp), %rdi
	movl	%ebp, %edx
...
# %bb.31:                               #   in Loop: Header=BB14_25 Depth=1
	...
	vcvtss2sd	%xmm1, %xmm1, %xmm1
	vcvtss2sd	%xmm0, %xmm0, %xmm0
	vmovsd	64(%rsp), %xmm2                 # 8-byte Reload
                                        # xmm2 = mem[0],zero
...
.LBB14_39:                              #   in Loop: Header=BB14_37 Depth=1
	...
	cmpq	%rax, %rbx
	je	.LBB14_36
.LBB14_40:                              #   in Loop: Header=BB14_37 Depth=1
	vmovss	(%rbx), %xmm0                   # xmm0 = mem[0],zero,zero,zero
...
.LBB14_46:
	movq	%rbx, 88(%rsp)
	vcvttss2usi	52(%rsp), %edx          # 4-byte Folded Reload
.Ltmp239:
	leaq	80(%rsp), %rdi
...
# %bb.50:
	vxorps	%xmm1, %xmm1, %xmm1
	movl	$1, %eax
	vbroadcastss	.LCPI14_12(%rip), %xmm2 # xmm2 = [NaN,NaN,NaN,NaN]
	.p2align	4, 0x90
...
.LBB14_53:
	...
	je	.LBB14_55
# %bb.54:
	vandps	.LCPI14_12(%rip){1to4}, %xmm2, %xmm0
...
# %bb.11:                               #   in Loop: Header=BB15_8 Depth=1
	vmovss	%xmm1, (%rbx,%rdi,4)
	cmpq	%rdx, %rdi
	jae	.LBB15_16
.LBB15_13:                              #   in Loop: Header=BB15_8 Depth=1
	vmovss	(%rbx,%rdi,4), %xmm1            # xmm1 = mem[0],zero,zero,zero
	movq	%r9, %rcx
	.p2align	4, 0x90
.LBB15_14:                              #   Parent Loop BB15_8 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vaddss	(%rbx,%rcx,4), %xmm1, %xmm1
	movl	$0, -4(%rbx,%rcx,4)
	incq	%rcx
	cmpq	%rcx, %rax
	jne	.LBB15_14
# %bb.15:                               #   in Loop: Header=BB15_8 Depth=1
	vmovss	%xmm1, -4(%rbx,%rax,4)
	jmp	.LBB15_16
.LBB15_17:
	testl	%r14d, %r14d
	je	.LBB15_18
...
# %bb.0:
	...
	vcvtusi2sd	%ebp, %xmm1, %xmm0
	vmovsd	%xmm0, 16(%rsp)                 # 8-byte Spill
	vmulsd	.LCPI16_3(%rip), %xmm0, %xmm0
	vpbroadcastq	.LCPI16_5(%rip), %xmm1  # xmm1 = [-0.0E+0,-0.0E+0]
	vpternlogq	$234, .LCPI16_4(%rip){1to2}, %xmm0, %xmm1
	vaddsd	%xmm1, %xmm0, %xmm0
	...
	testl	%ebp, %ebp
	vmovsd	%xmm4, 24(%rsp)                 # 8-byte Spill
	je	.LBB16_2
# %bb.1:
	leaq	(,%r13,8), %r14
	movq	%r14, %rdi
...
.LBB16_8:
	...
	vxorpd	%xmm0, %xmm0, %xmm0
	vucomisd	%xmm0, %xmm4
	vpbroadcastq	.LCPI16_4(%rip), %xmm3  # xmm3 = [4.9999999999999994E-1,4.9999999999999994E-1]
...
.LBB16_10:                              # =>This Inner Loop Header: Depth=1
	...
	vmulss	.LCPI16_8(%rip), %xmm0, %xmm0
	vcvtss2sd	%xmm0, %xmm0, %xmm0
	vmulsd	48(%rsp), %xmm0, %xmm0          # 8-byte Folded Reload
	vmovdqa	%xmm3, %xmm1
	vpternlogq	$248, .LCPI16_5(%rip){1to2}, %xmm0, %xmm1
	vaddsd	%xmm1, %xmm0, %xmm0
	vroundsd	$11, %xmm0, %xmm0, %xmm0
	movl	%ebx, %eax
	vmovsd	%xmm0, (%r13,%rax,8)
	incl	%ebx
	vcvtusi2sd	%ebx, %xmm5, %xmm0
	vucomisd	%xmm0, %xmm2
	ja	.LBB16_10
# %bb.11:
	vmovsd	8(%rsp), %xmm0                  # 8-byte Reload
                                        # xmm0 = mem[0],zero
	vmulsd	.LCPI16_6(%rip), %xmm0, %xmm0
	vpternlogq	$248, .LCPI16_5(%rip){1to2}, %xmm0, %xmm3
	vaddsd	%xmm3, %xmm0, %xmm0
	vroundsd	$11, %xmm0, %xmm0, %xmm0
	vaddsd	.LCPI16_2(%rip), %xmm0, %xmm0
	vmovsd	%xmm0, (%r13)
	vaddsd	.LCPI16_7(%rip), %xmm2, %xmm0
...
.LBB16_12:                              # =>This Inner Loop Header: Depth=1
	...
	vmulsd	.LCPI16_9(%rip), %xmm0, %xmm0
	vmovsd	%xmm0, 32(%rsp)                 # 8-byte Spill
	movl	%ebx, %ebp
	vcvttsd2si	(%r13,%rbp,8), %edi
	vmovsd	.LCPI16_2(%rip), %xmm0          # xmm0 = mem[0],zero
	callq	ldexp@PLT
	vmovsd	24(%rsp), %xmm4                 # 8-byte Reload
                                        # xmm4 = mem[0],zero
	vfmsub132sd	32(%rsp), %xmm0, %xmm0  # 8-byte Folded Reload
                                        # xmm0 = (xmm0 * mem) - xmm0
	...
	jmp	.LBB16_14
.LBB16_13:
	vmulsd	.LCPI16_6(%rip), %xmm1, %xmm0
	vpternlogq	$248, .LCPI16_5(%rip){1to2}, %xmm0, %xmm3
	vaddsd	%xmm3, %xmm0, %xmm0
	vroundsd	$11, %xmm0, %xmm0, %xmm0
	vaddsd	.LCPI16_2(%rip), %xmm0, %xmm0
	vmovsd	%xmm0, (%r13)
	vaddsd	.LCPI16_7(%rip), %xmm4, %xmm0
	vcvttsd2usi	%xmm0, %rax
	movq	$0, (%r13,%rax,8)
.LBB16_14:
	vmovsd	16(%rsp), %xmm0                 # 8-byte Reload
...
# %bb.15:
	...
	je	.LBB16_18
# %bb.16:
	vmovsd	%xmm6, 32(%rsp)                 # 8-byte Spill
	shlq	$3, %rbp
.Ltmp250:
	movq	%rbp, %rdi
	callq	_Znwm
...
.LBB16_19:
	...
	vaddsd	.LCPI16_7(%rip), %xmm6, %xmm0
	vmovsd	48(%rsp), %xmm5                 # 8-byte Reload
                                        # xmm5 = mem[0],zero
	vmovsd	%xmm5, (%rbx)
...
# %bb.23:
	...
	sarq	$3, %rcx
	movq	%rcx, 152(%rsp)                 # 8-byte Spill
	vcvttsd2usi	128(%rsp), %ebp         # 8-byte Folded Reload
	movl	%eax, %r14d
	jmp	.LBB16_25
	.p2align	4, 0x90
...
.LBB16_25:                              # =>This Inner Loop Header: Depth=1
	callq	rand
	movl	%eax, %r13d
	vcvtusi2sd	%r14d, %xmm7, %xmm0
	vsubsd	24(%rsp), %xmm0, %xmm0          # 8-byte Folded Reload
	vcvttsd2usi	%xmm0, %rax
	vcvttsd2si	(%rbx,%rax,8), %edi
	vmovsd	.LCPI16_2(%rip), %xmm0          # xmm0 = mem[0],zero
	callq	ldexp@PLT
	vcvtsi2sd	%r13d, %xmm7, %xmm1
	vmovsd	%xmm0, 32(%rsp)                 # 8-byte Spill
	vmulsd	.LCPI16_9(%rip), %xmm1, %xmm0
	vmovsd	%xmm0, 48(%rsp)                 # 8-byte Spill
	vxorpd	%xmm0, %xmm0, %xmm0
...
# %bb.31:                               #   in Loop: Header=BB16_25 Depth=1
	vmovsd	32(%rsp), %xmm1                 # 8-byte Reload
                                        # xmm1 = mem[0],zero
	vfmsub132sd	48(%rsp), %xmm1, %xmm1  # 8-byte Folded Reload
                                        # xmm1 = (xmm1 * mem) - xmm1
...
.LBB16_46:
	movq	%rbx, 72(%rsp)
	vcvttsd2usi	128(%rsp), %edx         # 8-byte Folded Reload
.Ltmp266:
	leaq	64(%rsp), %rdi
...
# %bb.50:
	vxorpd	%xmm1, %xmm1, %xmm1
	movl	$1, %eax
	vmovddup	.LCPI16_10(%rip), %xmm2         # xmm2 = [NaN,NaN]
                                        # xmm2 = mem[0,0]
	.p2align	4, 0x90
.LBB16_51:                              # =>This Inner Loop Header: Depth=1
	leal	-1(%rax), %ecx
	vmovsd	(%r15,%rcx,8), %xmm3            # xmm3 = mem[0],zero
...
.LBB16_53:
	...
	je	.LBB16_55
# %bb.54:
	vandpd	.LCPI16_10(%rip){1to2}, %xmm2, %xmm0
	vdivsd	%xmm0, %xmm1, %xmm0
.LBB16_55:
	vmovsd	%xmm0, (%rdx)
...
.Lcst_end9:
	.p2align	2, 0x0
                                        # -- End function
	.section	.rodata.cst8,"aM",@progbits,8
	.p2align	3, 0x0                          # -- Begin function _Z18gen_fpnumber_printIdEvRSt6vectorIT_SaIS1_EEiS1_RS1_
.LCPI17_0:
	.quad	0x7fffffffffffffff              #  NaN
.LCPI17_1:
	.quad	0x3810000000000000              #  1.1754943508222875E-38
...
# %bb.0:
	...
	vpbroadcastq	.LCPI19_5(%rip), %xmm1  # xmm1 = [-0.0E+0,-0.0E+0]
	vpternlogq	$234, .LCPI19_4(%rip){1to2}, %xmm0, %xmm1
	vaddsd	%xmm1, %xmm0, %xmm0
	vroundsd	$11, %xmm0, %xmm0, %xmm0
...
.LBB19_10:                              # =>This Inner Loop Header: Depth=1
	...
	vcvtss2sd	%xmm0, %xmm0, %xmm0
	kmovd	%eax, %k1
	vmovsd	.LCPI19_8(%rip), %xmm1          # xmm1 = mem[0],zero
	vmovsd	.LCPI19_3(%rip), %xmm1 {%k1}
	vaddsd	%xmm0, %xmm1, %xmm0
	vcvttpd2dq	%xmm0, %xmm0
	vcvtdq2ps	%xmm0, %xmm0
	movl	%ebx, %eax
...
# %bb.11:
	vmovsd	56(%rsp), %xmm0                 # 8-byte Reload
                                        # xmm0 = mem[0],zero
	vmulsd	.LCPI19_3(%rip), %xmm0, %xmm0
	vpbroadcastq	.LCPI19_4(%rip), %xmm1  # xmm1 = [4.9999999999999994E-1,4.9999999999999994E-1]
	vpternlogq	$248, .LCPI19_5(%rip){1to2}, %xmm0, %xmm1
	vaddsd	%xmm1, %xmm0, %xmm0
	vroundsd	$11, %xmm0, %xmm0, %xmm0
	vaddsd	.LCPI19_2(%rip), %xmm0, %xmm0
	vcvtsd2ss	%xmm0, %xmm0, %xmm0
	vaddss	.LCPI19_6(%rip), %xmm2, %xmm1
	vcvttss2usi	%xmm1, %rax
	vmovss	%xmm0, (%rbp)
	movl	$0, (%rbp,%rax,4)
	xorl	%ebx, %ebx
...
.LBB19_12:                              # =>This Inner Loop Header: Depth=1
	...
	vmulss	.LCPI19_7(%rip), %xmm0, %xmm0
	vcvtss2sd	%xmm0, %xmm0, %xmm0
	vmovsd	.LCPI19_10(%rip), %xmm1         # xmm1 = mem[0],zero
	vfmadd132sd	.LCPI19_9(%rip), %xmm1, %xmm0 # xmm0 = (xmm0 * mem) + xmm1
	vcvtsd2ss	%xmm0, %xmm0, %xmm0
	vcvtss2sd	%xmm0, %xmm0, %xmm0
	vmovsd	%xmm0, 16(%rsp)                 # 8-byte Spill
	movl	%ebx, %ebp
	vcvttss2si	(%r15,%rbp,4), %edi
	...
	jmp	.LBB19_14
.LBB19_13:
	vmulsd	.LCPI19_3(%rip), %xmm2, %xmm0
	vpbroadcastq	.LCPI19_4(%rip), %xmm2  # xmm2 = [4.9999999999999994E-1,4.9999999999999994E-1]
	vpternlogq	$248, .LCPI19_5(%rip){1to2}, %xmm0, %xmm2
	...
	movq	40(%rsp), %rcx                  # 8-byte Reload
	vmovss	%xmm0, (%rcx)
	vaddss	.LCPI19_6(%rip), %xmm1, %xmm0
	vcvttss2usi	%xmm0, %rax
	movl	$0, (%rcx,%rax,4)
.LBB19_14:
	vcvtusi2ssl	36(%rsp), %xmm4, %xmm0  # 4-byte Folded Reload
	vsubss	%xmm1, %xmm0, %xmm5
	vcvttss2usi	%xmm5, %rbp
	cmpq	%r14, %rbp
...
# %bb.17:
	...
	vmovss	64(%rsp), %xmm4                 # 4-byte Reload
                                        # xmm4 = mem[0],zero,zero,zero
	vmovss	16(%rsp), %xmm5                 # 4-byte Reload
                                        # xmm5 = mem[0],zero,zero,zero
	jmp	.LBB19_19
.LBB19_18:
	xorl	%ebx, %ebx
.LBB19_19:
	...
	vaddss	.LCPI19_6(%rip), %xmm5, %xmm0
	vmovss	%xmm4, (%rbx)
	vucomiss	.LCPI19_11(%rip), %xmm5
	jbe	.LBB19_22
# %bb.20:
...
.LBB19_22:
	...
	movl	$.Lstr.46, %edi
	callq	puts@PLT
	vcvttss2usi	12(%rsp), %eax          # 4-byte Folded Reload
	cmpl	36(%rsp), %eax                  # 4-byte Folded Reload
	movq	%rbx, 24(%rsp)                  # 8-byte Spill
	jae	.LBB19_33
# %bb.23:
...
.LBB19_24:                              #   in Loop: Header=BB19_25 Depth=1
	incq	%r15
	cmpl	%r15d, 176(%rsp)                # 4-byte Folded Reload
	je	.LBB19_33
.LBB19_25:                              # =>This Inner Loop Header: Depth=1
	callq	rand
	movl	%eax, %r14d
	vcvtusi2ss	%r15d, %xmm6, %xmm0
	vmovss	%xmm0, 16(%rsp)                 # 4-byte Spill
	vsubss	12(%rsp), %xmm0, %xmm0          # 4-byte Folded Reload
	vcvttss2usi	%xmm0, %rax
	vcvttss2si	(%rbx,%rax,4), %edi
	vmovsd	.LCPI19_2(%rip), %xmm0          # xmm0 = mem[0],zero
	callq	ldexp@PLT
	vcvtsi2ss	%r14d, %xmm6, %xmm1
	vmulss	.LCPI19_7(%rip), %xmm1, %xmm1
	vcvtss2sd	%xmm1, %xmm1, %xmm1
	vmovsd	%xmm0, 64(%rsp)                 # 8-byte Spill
	vmovsd	.LCPI19_10(%rip), %xmm0         # xmm0 = mem[0],zero
	vfmadd132sd	.LCPI19_9(%rip), %xmm0, %xmm1 # xmm1 = (xmm1 * mem) + xmm0
	vmovsd	%xmm1, 56(%rsp)                 # 8-byte Spill
	vxorpd	%xmm0, %xmm0, %xmm0
	vmovupd	%xmm0, 112(%rsp)                # AlignMOV convert to UnAlignMOV 
	movq	$0, 128(%rsp)
...
# %bb.31:                               #   in Loop: Header=BB19_25 Depth=1
	...
	movq	24(%rsp), %rbx                  # 8-byte Reload
	je	.LBB19_24
# %bb.32:                               #   in Loop: Header=BB19_25 Depth=1
	callq	_ZdlPv
	jmp	.LBB19_24
.LBB19_33:
	movl	$.Lstr.47, %edi
...
# %bb.50:
	vxorps	%xmm1, %xmm1, %xmm1
	movl	$1, %eax
	vbroadcastss	.LCPI19_12(%rip), %xmm2 # xmm2 = [NaN,NaN,NaN,NaN]
	.p2align	4, 0x90
...
.LBB19_53:
	...
	je	.LBB19_55
# %bb.54:
	vandps	.LCPI19_12(%rip){1to4}, %xmm2, %xmm0
	vdivss	%xmm0, %xmm1, %xmm0
.LBB19_55:
	vmovss	%xmm0, (%rdx)
	movl	$.Lstr.48, %edi
...
# %bb.0:
	...
	vcvtusi2sd	%ebp, %xmm1, %xmm0
	vmovsd	%xmm0, 16(%rsp)                 # 8-byte Spill
	vmulsd	.LCPI20_3(%rip), %xmm0, %xmm0
	vpbroadcastq	.LCPI20_5(%rip), %xmm1  # xmm1 = [-0.0E+0,-0.0E+0]
	vpternlogq	$234, .LCPI20_4(%rip){1to2}, %xmm0, %xmm1
	vaddsd	%xmm1, %xmm0, %xmm0
...
.LBB20_10:
	...
	vmovsd	8(%rsp), %xmm2                  # 8-byte Reload
                                        # xmm2 = mem[0],zero
	vmulsd	.LCPI20_0(%rip), %xmm2, %xmm3
	movabsq	$1152921504606846975, %r12      # imm = 0xFFFFFFFFFFFFFFF
	vxorpd	%xmm0, %xmm0, %xmm0
	vucomisd	%xmm0, %xmm1
	vpbroadcastq	.LCPI20_4(%rip), %xmm4  # xmm4 = [4.9999999999999994E-1,4.9999999999999994E-1]
...
.LBB20_12:                              # =>This Inner Loop Header: Depth=1
	callq	rand
	vpbroadcastq	.LCPI20_4(%rip), %xmm2  # xmm2 = [4.9999999999999994E-1,4.9999999999999994E-1]
	vcvtsi2ss	%eax, %xmm5, %xmm0
	vmulss	.LCPI20_8(%rip), %xmm0, %xmm0
	vcvtss2sd	%xmm0, %xmm0, %xmm0
	vmulsd	48(%rsp), %xmm0, %xmm0          # 8-byte Folded Reload
	vmovdqa	%xmm2, %xmm1
	vpternlogq	$248, .LCPI20_5(%rip){1to2}, %xmm0, %xmm1
	vaddsd	%xmm1, %xmm0, %xmm0
	vmovsd	24(%rsp), %xmm1                 # 8-byte Reload
                                        # xmm1 = mem[0],zero
	vroundsd	$11, %xmm0, %xmm0, %xmm0
...
# %bb.13:
	vmovsd	8(%rsp), %xmm0                  # 8-byte Reload
                                        # xmm0 = mem[0],zero
	vmulsd	.LCPI20_6(%rip), %xmm0, %xmm0
	vpternlogq	$248, .LCPI20_5(%rip){1to2}, %xmm0, %xmm2
	vaddsd	%xmm2, %xmm0, %xmm0
	vroundsd	$11, %xmm0, %xmm0, %xmm0
	vaddsd	.LCPI20_2(%rip), %xmm0, %xmm0
	vmovsd	%xmm0, (%r13)
	vaddsd	.LCPI20_7(%rip), %xmm1, %xmm0
	vcvttsd2usi	%xmm0, %rax
	movq	$0, (%r13,%rax,8)
	xorl	%ebx, %ebx
	.p2align	4, 0x90
.LBB20_14:                              # =>This Inner Loop Header: Depth=1
	...
	jmp	.LBB20_16
.LBB20_15:
	vmulsd	.LCPI20_6(%rip), %xmm2, %xmm0
	vpternlogq	$248, .LCPI20_5(%rip){1to2}, %xmm0, %xmm4
...
# %bb.19:
	...
	je	.LBB20_20
# %bb.21:
	vmovsd	%xmm5, 32(%rsp)                 # 8-byte Spill
	shlq	$3, %rbp
.Ltmp304:
	movq	%rbp, %rdi
	callq	_Znwm
...
.LBB20_26:
	...
	movl	$.Lstr.46, %edi
	callq	puts@PLT
	vcvttsd2usi	24(%rsp), %eax          # 8-byte Folded Reload
	cmpl	44(%rsp), %eax                  # 4-byte Folded Reload
	movq	%r13, 16(%rsp)                  # 8-byte Spill
	movq	%rbx, 8(%rsp)                   # 8-byte Spill
	jae	.LBB20_39
# %bb.27:
	...
	jmp	.LBB20_28
	.p2align	4, 0x90
.LBB20_38:                              #   in Loop: Header=BB20_28 Depth=1
	incq	%r14
	cmpl	%r14d, 160(%rsp)                # 4-byte Folded Reload
	je	.LBB20_39
.LBB20_28:                              # =>This Inner Loop Header: Depth=1
	callq	rand
	movl	%eax, %r13d
	vcvtusi2sd	%r14d, %xmm6, %xmm0
	vsubsd	24(%rsp), %xmm0, %xmm0          # 8-byte Folded Reload
	vcvttsd2usi	%xmm0, %rax
	vcvttsd2si	(%rbx,%rax,8), %edi
	vmovsd	.LCPI20_2(%rip), %xmm0          # xmm0 = mem[0],zero
	callq	ldexp@PLT
	vcvtsi2sd	%r13d, %xmm6, %xmm1
	vmovsd	%xmm0, 32(%rsp)                 # 8-byte Spill
	vmulsd	.LCPI20_9(%rip), %xmm1, %xmm0
	vmovsd	%xmm0, 48(%rsp)                 # 8-byte Spill
	vxorpd	%xmm0, %xmm0, %xmm0
	vmovupd	%xmm0, 96(%rsp)                 # AlignMOV convert to UnAlignMOV 
	movq	$0, 112(%rsp)
	cmpq	%r15, 56(%rsp)                  # 8-byte Folded Reload
	je	.LBB20_29
# %bb.30:                               #   in Loop: Header=BB20_28 Depth=1
	movabsq	$9223372036854775800, %rax      # imm = 0x7FFFFFFFFFFFFFF8
	cmpq	%rax, %r12
	ja	.LBB20_31
# %bb.33:                               #   in Loop: Header=BB20_28 Depth=1
.Ltmp306:
	movq	%r12, %rdi
	movq	16(%rsp), %r13                  # 8-byte Reload
	callq	_Znwm
...
# %bb.34:                               #   in Loop: Header=BB20_28 Depth=1
	...
	jmp	.LBB20_35
	.p2align	4, 0x90
.LBB20_29:                              #   in Loop: Header=BB20_28 Depth=1
	movq	%r12, 112(%rsp)
	movq	%r12, %rbx
	movq	16(%rsp), %r13                  # 8-byte Reload
.LBB20_35:                              #   in Loop: Header=BB20_28 Depth=1
	movq	%rbx, 104(%rsp)
.Ltmp312:
	leaq	96(%rsp), %rdi
	movl	%r14d, %esi
...
# %bb.36:                               #   in Loop: Header=BB20_28 Depth=1
	...
	movq	8(%rsp), %rbx                   # 8-byte Reload
	je	.LBB20_38
# %bb.37:                               #   in Loop: Header=BB20_28 Depth=1
	callq	_ZdlPv
	jmp	.LBB20_38
.LBB20_39:
	movl	$.Lstr.47, %edi
...
# %bb.41:
	...
	jmp	.LBB20_42
	.p2align	4, 0x90
.LBB20_52:                              #   in Loop: Header=BB20_42 Depth=1
	leaq	(%r15,%rbp), %rax
	addq	$8, %rax
	addq	$8, %rbp
	cmpq	%r12, %rax
...
.LBB20_42:                              # =>This Inner Loop Header: Depth=1
	...
	shrq	$32, %rdx
	je	.LBB20_43
# %bb.49:                               #   in Loop: Header=BB20_42 Depth=1
	movq	%rcx, %rax
	cqto
	idivq	%rsi
	leaq	(%r15,%rdx,8), %rax
	...
	jmp	.LBB20_52
	.p2align	4, 0x90
.LBB20_43:                              #   in Loop: Header=BB20_42 Depth=1
	xorl	%edx, %edx
	divl	%esi
                                        # kill: def $edx killed $edx def $rdx
	leaq	(%r15,%rdx,8), %rax
	cmpq	%rax, %rbx
	je	.LBB20_52
.LBB20_51:                              #   in Loop: Header=BB20_42 Depth=1
	vmovsd	(%rbx), %xmm0                   # xmm0 = mem[0],zero
	vmovsd	(%rax), %xmm1                   # xmm1 = mem[0],zero
	vmovsd	%xmm1, (%rbx)
	vmovsd	%xmm0, (%rax)
...
# %bb.64:
	vxorpd	%xmm1, %xmm1, %xmm1
	movl	$1, %eax
	vmovddup	.LCPI20_10(%rip), %xmm2         # xmm2 = [NaN,NaN]
                                        # xmm2 = mem[0,0]
	.p2align	4, 0x90
...
.LBB20_67:
	...
	je	.LBB20_69
# %bb.68:
	vandpd	.LCPI20_10(%rip){1to2}, %xmm2, %xmm0
	vdivsd	%xmm0, %xmm1, %xmm0
.LBB20_69:
	vmovsd	%xmm0, (%rdx)
	movl	$.Lstr.48, %edi
