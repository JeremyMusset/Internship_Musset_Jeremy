...
.Lcst_begin0:
	...
	.byte	0                               #   On action: cleanup
	.uleb128 .Ltmp64-.Lfunc_begin0          # >> Call Site 24 <<
	.uleb128 .Lfunc_end0-.Ltmp64            #   Call between .Ltmp64 and .Lfunc_end0
	.byte	0                               #     has no landing pad
	.byte	0                               #   On action: cleanup
.Lcst_end0:
	.p2align	2, 0x0
	...
	.p2align	4, 0x90                         # -- Begin function _GLOBAL__sub_I_compare_time_vec3.cpp
	.type	_GLOBAL__sub_I_compare_time_vec3.cpp,@function
_GLOBAL__sub_I_compare_time_vec3.cpp:   # 
	.cfi_startproc
# %bb.0:
	pushq	%rax
	.cfi_def_cfa_offset 16
...
.Lfunc_end1:
	.size	_GLOBAL__sub_I_compare_time_vec3.cpp, .Lfunc_end1-_GLOBAL__sub_I_compare_time_vec3.cpp
	.cfi_endproc
                                        # -- End function
...
.L.str.5:
	...
	.p2align	3, 0x0
	.quad	_GLOBAL__sub_I_compare_time_vec3.cpp
	.type	.Lstr.7,@object                 # 
	.section	.rodata.str1.1,"aMS",@progbits,1
.Lstr.7:
	.asciz	"};"
