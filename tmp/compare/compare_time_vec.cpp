...
int main() {
    ...
    // Time / Size
    int sz_time = 20;    // 20 ou 28
    class std::vector<double> VSize(sz_time);
    class std::vector<double> VSize_big(sz_time);
    ...
    VSize_big = {5000,10000,15000,20000,25000,30000,40000,50000,75000, 100000,200000,300000,400000,500000,625000,750000,875000,1000000,1500000,2000000,5000000,10000000,20000000,35000000,50000000,60000000,80000000,100000000};


    int i = 0;
    vector<double>::iterator k;
    for (k = VSize_big.begin(); k != VSize.end(); k++){  
        // Exec dot prod
        printf("~~~~~~~~~~~~~~~~ SIZE = %.30f ~~~~~~~~~~~~~~~~~ ",*k);
